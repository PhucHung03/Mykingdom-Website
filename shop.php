        ...
        <div class="container">
            <div class="row">
                                        ...
                                        ?>
                                            <div class="card">
                                                <div class="card-heading active">
                                                    <!-- Liên kết lọc sản phẩm theo danh mục -->
                ...
                <div class="col-lg-9 col-md-9">
                    ...
                    <div class="row">
                        ...
                        // Truy vấn sản phẩm có điều kiện lọc theo danh mục nếu người dùng chọn
                        $sql_str = "SELECT 
                products.id AS pid,
            ...
            ON 
                products.category_id = categories.id";
                        ...
                        // Nếu có danh mục, thêm điều kiện lọc WHERE
                        if (!empty($category)) {
                            $sql_str .= " WHERE categories.slug = '$category'";
                        }

                        // Sắp xếp sản phẩm theo mức giảm giá
                        $sql_str .= " ORDER BY discount";
                                ...
                                <div class="col-lg-4 col-md-6 col-6-rp-mobile mix <?= $row['cslug'] ?>">
                                    <div class="product__item sale">
                                        ...
                                        <div class="product__item__text">
                                            <h6 class="text-truncate-1"><a href="product-details.php?id=<?= $row['pid'] ?>"><?= $row["pname"] ?></a></h6>
